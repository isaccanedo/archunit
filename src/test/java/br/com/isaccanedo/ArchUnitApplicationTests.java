...
class ArchUnitApplicationTests {
	...
	public void setup() {
		importedClasses = new ClassFileImporter()
				...
				.importPackages("br.com.isaccanedo");
	}
	...
	void servicesAndRepositoriesShouldNotDependOnWebLayer() {
		...
		noClasses()
				.that().resideInAnyPackage("br.com.isaccanedo.service..")
				.or().resideInAnyPackage("br.com.isaccanedo.repository..")
				.should()
				.dependOnClassesThat()
				.resideInAnyPackage("br.com.isaccanedo.controller..")
